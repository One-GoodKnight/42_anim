...
{
	render_line(corner.org.x + corner.offset.x, corner.org.y + corner.offset.y, corner.thickness, corner.line_one_dir, corner.line_one_length);
	render_line(corner.org.x + corner.offset.x, corner.org.y + corner.offset.y, corner.thickness, corner.line_two_dir, corner.line_two_length);
}
